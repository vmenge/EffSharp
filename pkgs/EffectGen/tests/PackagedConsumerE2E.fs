...
module PackagedConsumerE2E =
  ...
  let tests =
    testSequenced <| testList "PackagedConsumerE2E" [
      testTask "packed EffectGen package restores, builds, and runs in a consumer fixture" {
        ...
        Expect.equal packResult.ExitCode 0 $"EffectGen should pack successfully before the packaged consumer build. Output:{System.Environment.NewLine}{packResult.Output}"
