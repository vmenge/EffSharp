module EffFs.EffectGen.Tool.Program
...
let main argv =
  ...
  | _ ->
      fail
        "usage: EffectGen.Tool --project-directory <path> --intermediate-output-path <path> --compile-items-file <path> --parse-args-file <path> --ordered-compile-items-file <path> --other-flags-file <path>"
