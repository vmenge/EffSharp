  ...
  let tests =
    testSequenced <| testList "QualifiedReturnTypesE2E" [
      testTask "qualified supported return types build and normalize like unqualified forms" {
        ...
        Expect.stringContains generatedText "static member Parse (arg1: string) : EffSharp.Core.Eff<int, QualifiedReturnTypesRed.ParseError, #IParser>" "qualified Result should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member Fetch (arg1: string) : EffSharp.Core.Eff<QualifiedReturnTypesRed.Response, 'e, #IHttp>" "qualified Task should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member TryFetch (arg1: string) : EffSharp.Core.Eff<QualifiedReturnTypesRed.Response, QualifiedReturnTypesRed.HttpError, #IHttp>" "qualified Task<Result<_,_>> should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member Load (arg1: string) : EffSharp.Core.Eff<QualifiedReturnTypesRed.Model, 'e, #IStore>" "qualified Async should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member TryLoad (arg1: string) : EffSharp.Core.Eff<QualifiedReturnTypesRed.Model, QualifiedReturnTypesRed.StoreError, #IStore>" "qualified Async<Result<_,_>> should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member Read (arg1: string) : EffSharp.Core.Eff<string, 'e, #IFileSystem>" "qualified ValueTask should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member TryRead (arg1: string) : EffSharp.Core.Eff<string, QualifiedReturnTypesRed.FileError, #IFileSystem>" "qualified ValueTask<Result<_,_>> should stay fully qualified in generated output without rewriting the member name"
        Expect.stringContains generatedText "static member Spawn (arg1: QualifiedReturnTypesRed.Job) : EffSharp.Core.Eff<QualifiedReturnTypesRed.JobHandle<QualifiedReturnTypesRed.JobResult>, QualifiedReturnTypesRed.SpawnError, #IRuntime>" "qualified Eff should stay fully qualified in generated output without rewriting the member name"
